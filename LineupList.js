...
const lineup = [
    ...
    {name: "Nviiri the Storyteller", country: "KE", 
    ...
    {name: "H_art the Band", country: "KE", 
    ...
    {name: "Sanaipei Tande", country: "KE", 
