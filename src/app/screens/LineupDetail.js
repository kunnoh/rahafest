...
import { StyleSheet, View, Image, Dimensions, ImageBackground, Pressable } from "react-native";
  ...
  <span style={{ color: "#11e0ff" }}>T</span> **/}
       ...
       <MamaKilo color="#ffffff" size={25} height={35}>Food, Art, Culture, Music</MamaKilo>
        ...
        <View
          ...
          <MamaKilo color="white" size={40} height={50}>
            {route.params.item.name}
          </MamaKilo>

          <MamaKilo color="white" size={30} height={40}>
            {route.params.item.country}
          </MamaKilo>
